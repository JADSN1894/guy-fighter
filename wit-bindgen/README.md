...
below][hosts]. Languages developed in this repository are Rust, C, Zig,
Java (TeaVM Java), Go (TinyGo), and C#. If you encounter any problems feel free to [open an
...
### Guest: Zig
To start in Zig a `*.zig` file is generated for your project to use.
These files are generated with the [`wit-bindgen` CLI command][cli-install] in this repository.
